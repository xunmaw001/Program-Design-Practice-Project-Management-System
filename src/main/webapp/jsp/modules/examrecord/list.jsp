...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">考试记录表管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">考试记录表列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">考试记录表列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        实践项目状态
                                        <div class="layui-input-inline">
                                            <select name="exampaperTypesSelectSearch"  style="width: 150px;" id="exampaperTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //考试编号
            var examrecordUuidNumberCell = document.createElement('td');
            examrecordUuidNumberCell.innerHTML = item.examrecordUuidNumber;
            row.appendChild(examrecordUuidNumberCell);
            ...
            totalScoreCell.innerHTML = item.totalScore;
            ...
            var detailAttr = "detail(" + item.examrecordUuidNumber + ')';
            detailBtn.setAttribute("type", "button");
            detailBtn.setAttribute("class", "btn btn-info btn-sm 查看");
            detailBtn.setAttribute("onclick", detailAttr);
            detailBtn.innerHTML = "查看答题详情";
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("examrecord/deleteExamrecord", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addexamrecord", "addexamrecord");
            window.location.href = "add-or-update.jsp"
        }
        ...
        // 查看详情
        function detail(id) {
            window.sessionStorage.setItem("uuid", id);
            window.location.href = "../examredetails/list.jsp";
        }
