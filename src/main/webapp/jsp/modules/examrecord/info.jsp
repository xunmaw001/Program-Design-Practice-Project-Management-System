            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">考试记录表登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="exampaperValue" name="exampaperValue" class="form-control"
                                               v-model="ruleForm.exampaperValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="examrecordUuidNumber" name="examrecordUuidNumber" class="form-control"
                                               v-model="ruleForm.examrecordUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="exampaperId" name="exampaperId" v-model="ruleForm.exampaperId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="totalScore" name="totalScore" class="form-control"
                                               v-model="ruleForm.totalScore" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "examrecord/info/" + id,
