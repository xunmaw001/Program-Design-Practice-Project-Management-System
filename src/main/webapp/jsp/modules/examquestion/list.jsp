                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">试题表列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">试题表列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="examquestionNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        分值
                                        <div class="layui-input-inline">
                                            <input type="text" id="examquestionScoreStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="examquestionScoreChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="examquestionScoreEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="examquestionScoreChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        实践项目名称
                                        <div class="layui-input-inline">
                                            <input type="text" id="exampaperNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="实践项目名称" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( examquestionNameSearchInput != null){
                ...
                //分值
            var examquestionScoreStartSearchInput = $('#examquestionScoreStartSearch');
            if(examquestionScoreStartSearchInput != null){
                var examquestionScoreStartSearchValue = examquestionScoreStartSearchInput.val();
                if( examquestionScoreStartSearchValue  != 0){
                    searchForm.examquestionScoreStart = examquestionScoreStartSearchValue;
                }
            }
            var examquestionScoreEndSearchInput = $('#examquestionScoreEndSearch');
            if(examquestionScoreEndSearchInput != null){
                var examquestionScoreEndSearchValue = examquestionScoreEndSearchInput.val();
                if( examquestionScoreEndSearchValue  != 0){
                    searchForm.examquestionScoreEnd = examquestionScoreEndSearchValue;
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("examquestion/page", "GET", {
                ...
                examquestionScoreStart: searchForm.examquestionScoreStart,
                examquestionScoreEnd: searchForm.examquestionScoreEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            if(item.examquestionTypes == 1){
                examquestionTypesCell.innerHTML = "<span class=\"badge badge-success\">"+item.examquestionValue+"</span>"
            }else if(item.examquestionTypes == 2){
                examquestionTypesCell.innerHTML = "<span class=\"badge badge-danger\">"+item.examquestionValue+"</span>"
            }else if(item.examquestionTypes == 3){
                examquestionTypesCell.innerHTML = "<span class=\"badge badge-warning\">"+item.examquestionValue+"</span>"
            }else if(item.examquestionTypes == 4){
                examquestionTypesCell.innerHTML = "<span class=\"badge badge-info\">"+item.examquestionValue+"</span>"
            }
            ...
            //分值
            var examquestionScoreCell = document.createElement('td');
            examquestionScoreCell.innerHTML = item.examquestionScore;
            row.appendChild(examquestionScoreCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("examquestion/deleteExamquestion", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addexamquestion", "addexamquestion");
            window.location.href = "add-or-update.jsp"
        }
