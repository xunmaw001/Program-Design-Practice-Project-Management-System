        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">实践项目表管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">实践项目表管理</li>
                            <li class="breadcrumb-item active">实践项目表列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">实践项目表列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            if(window.sessionStorage.getItem('role') == '用户') {
                ...
                examBtn.setAttribute("class", "btn btn-info btn-sm 11");
        ...
        // 查看详情
        function exam(id) {
            var mymessage = confirm("你确定要进行考试吗？");
            if (mymessage == true) {
                httpJson("examrecord/saveExamrecord?exampaperId="+id, "get",null, (res) => {
                    if(res.code == 0){
                        alert("已创建考试记录");
                        window.sessionStorage.setItem("paperid", id);
                        window.sessionStorage.setItem("examrecordId", res.id);
                        window.sessionStorage.setItem("paperUUID", res.uuid);
