    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑实践项目表</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑实践项目表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">实践项目表信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="exampaperDate" name="exampaperDate" class="form-control"
                                               onchange="exampaperDateChickValue(this)"  placeholder="考试时长(分钟)">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>实践项目状态</label>
                                        <select style="width: 450px" id="exampaperTypesSelect" name="exampaperTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function exampaperDateChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                exampaperName: "实践项目名称不能为空",
                exampaperDate: "考试时长(分钟)不能为空",
                exampaperTypes: "实践项目状态不能为空",
            }
        }).form();
    }
