            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">意见反馈登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>反馈内容</label>
                                        <input style="width: 450px" id="yijianfankuiText" name="yijianfankuiText" class="form-control"
                                               v-model="ruleForm.yijianfankuiText" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yijianfankui/info/" + id,
