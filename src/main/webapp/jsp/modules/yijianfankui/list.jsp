...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">意见反馈管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">意见反馈列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">意见反馈列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("yijianfankui/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                yijianfankuiDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //反馈内容
            var yijianfankuiTextCell = document.createElement('td');
            yijianfankuiTextCell.innerHTML = item.yijianfankuiText;
            row.appendChild(yijianfankuiTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("yijianfankui/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addyijianfankui", "addyijianfankui");
            window.location.href = "add-or-update.jsp"
        }
