            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">答题详情表登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input style="width: 450px" id="examredetailsUuidNumber" name="examredetailsUuidNumber" class="form-control"
                                           v-model="ruleForm.examredetailsUuidNumber" readonly>
                                </div>
                                        <div class="form-group col-md-6">
                                            <label>试题名称</label>
                                            <textarea style="width: 450px" id="examquestionName" readonly v-model="ruleForm.examquestionName" name="examquestionName" class="form-control"rows="3" placeholder="试题名称" aria-required="true" aria-invalid="true"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>答案解析</label>
                                            <textarea style="width: 450px" id="examquestionAnalysis" readonly v-model="ruleForm.examquestionAnalysis" name="examquestionAnalysis" class="form-control"rows="3" placeholder="试题名称" aria-required="true" aria-invalid="true"></textarea>
                                        </div>
                                ...
                                <input id="examquestionId" name="examquestionId" v-model="ruleForm.examquestionId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="examredetailsMyscore" name="examredetailsMyscore" class="form-control"
                                               v-model="ruleForm.examredetailsMyscore" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "examredetails/info/" + id,
